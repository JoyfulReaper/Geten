...
namespace DumbTests
{
	public static class Program
	{
		private static void Main()
		{
			...
			var l = new ScriptLexer(SourceText.From(input));
			...
			var bn = (BlockNode)p.Parse("weapon \"sword\" with mindamage 10 and maxdamage 35 end end");
			VistChildNode(bn);
		}
		...
		private static void VistChildNode(SyntaxNode node)
		{
			...
			else
			{
				...
				foreach (var prop in properties)
				{
					...
					{
						var dict = (Dictionary<string, object>)prop.GetValue(node);
